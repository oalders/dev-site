...
import Footer from 'gatsby-theme-maxmind/components/Layout/Footer';
import Header from 'gatsby-theme-maxmind/components/Layout/Header';
import SEO from 'gatsby-theme-maxmind/components/Layout/Seo';
